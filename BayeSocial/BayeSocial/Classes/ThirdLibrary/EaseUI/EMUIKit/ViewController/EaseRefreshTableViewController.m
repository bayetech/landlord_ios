...
@property (nonatomic,nullable,weak) UIRefreshControl *refreshControl;
@end
...
//            }];
            ...
            [refreshControl addTarget:self action:@selector(tableViewDidTriggerHeaderRefresh) forControlEvents:UIControlEventValueChanged];
