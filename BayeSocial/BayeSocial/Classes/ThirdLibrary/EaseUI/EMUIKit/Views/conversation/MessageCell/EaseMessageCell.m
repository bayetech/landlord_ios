...
- (void)setCurrentIndexPath:(NSIndexPath *)currentIndexPath {
    ...
    self.avatarView.tag     = _currentIndexPath.row;
}
...
+ (CGFloat)cellHeightWithModel:(id<IMessageModel>)model
{
    ...
    switch (model.bodyType) {
        case EMMessageBodyTypeText:
        {
            ...
            UIEdgeInsets margin = cell.bubbleMargin;
            cell.bubbleMargin = UIEdgeInsetsMake(margin.top, margin.left, margin.bottom, 10.0);
