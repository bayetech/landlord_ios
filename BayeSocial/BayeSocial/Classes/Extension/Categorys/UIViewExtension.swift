...
extension UILabel {
    ...
    public var displaySize: CGSize {
        if let text = text {
            return (text as NSString).boundingRect(with: CGSize(width: Double(MAXFLOAT), height: Double(MAXFLOAT)), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSFontAttributeName:font], context: nil).size
        } else {
