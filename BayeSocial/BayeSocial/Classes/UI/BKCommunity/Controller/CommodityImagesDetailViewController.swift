...
//                NJLog(1)
	...
	func singleTapGestureRecognizer(_ sender: UITapGestureRecognizer){
        self.dismiss(animated: true, completion: nil)
	}

	func doubleTapGestureRecognizer(_ sender: UITapGestureRecognizer){
	...
	func handleLongpressGesture(_ sender: UITapGestureRecognizer) {
